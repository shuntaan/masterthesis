...
Firstly, in Section~\ref{sec:GammaDistribution}, we show the $\qn$ frequency dependence for each galaxy with the distribution of $\gamma$.
Secondly, in Section~\ref{sec:sfrfromlowradio}, we show the result of the comparison between the SFR from a radio emission and other indicators.
...
\section{Star Formation Rate (SFR) from the low-frequency emission}\label{sec:sfrfromlowradio}
