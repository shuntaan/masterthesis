...
\documentclass[11pt,a4paper,oneside,openright,final,titlepage]{report}
...
\begin{landscape}
    ...
    \caption[The overview of 18 samples used for the analysis]{\label{tab:sampletable}
        This table shows 18 HRS galaxies selected in Section~\ref{sec:sample}.
        ...
        $\alpha\msb{MWA}$, $\alpha\msb{MWA+1500\,MHz}$ are the result in Section~\ref{subsec:FrequencyDependenceOfQ}.
        $\mr{SFR}\msb{IR}$ is calculated with the equation from \citet{Murphy2011} and $\mr{SFR\msb{Radio,\,151\MHz}}$ is calculated in Section~\ref{subsec:sfrfromradioemission} with individual parameters.
...
\toprule
{} &   NGC &         R.A. &          Dec &      Type &   D25 &  Dist. &        GLEAM ID & $\alpha_{\mathrm{MWA}}$ & $\alpha_{\mathrm{MWA+1500MHz}}$ & $SFR_{\mathrm{IR}}$ & $SFR_{\mathrm{Radio},\,151\mathrm{MHz}}$ &   AGN & HI-def \\
