...
Here, I assume each electron emits the averaged power $\bra{P}$ (Equation~\ref{eq:essential_radio5n42}) with any energy $E$
...
Substituting $T\msb{b} \sim T\msb{e}$ and Equation~\ref{eq:essential_radio5n85} yields:
